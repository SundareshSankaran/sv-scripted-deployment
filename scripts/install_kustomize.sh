...
# NOTE (Sundaresh) : This is code that was acquired from public support forums (stackoverflow / similar) - I use this only if I need to resort to a manual deployment WITH kustomize
